...
export const RESOURCE_PAGES: ResourcePage[] = [
  ...
  },
  {
    ...
    excerpt:
      "Learn how Blouds organizes Weed and cannabis flower across five established tiers.",
    primaryKeyword: "Weed and flower guides",
    supportingKeywords: ["cannabis flower", "Exotic weed and flower", "Budget weed and flower"],
    searchIntent: "Understand and compare Blouds Weed and flower tiers.",
    author: "menu",
    datePublished: updated,
    dateModified: updated,
    image: { src: "/banners/Blouds_Exotic.webp", alt: "Blouds Weed and flower guide" },
    intro: [
      "Use the Blouds Weed & Flower Guides to learn how the site's flower tiers are organized before choosing where to browse next. Blouds separates flower into Exotic, Premium, AAA+, AA and Budget tiers, while the broader store uses Weed, Cannabis, Flower and Bud naturally across different shopping contexts.",
      "These guides support the existing Blouds Weed and flower pages rather than replacing them. If you already know which tier you want to explore, continue directly to that tier below.",
    ],
    sections: [
      {
      ...
      {
        heading: "Weed, Cannabis, Flower and Bud",
        body: [
          "Weed is a common everyday term shoppers use for cannabis.",
      ...
      {
        heading: "Looking for Blouds in Brampton?",
        body: [
          "For local store information, start with the Blouds Weed Dispensary in Brampton guide. For broader Blouds shopping and Cannabis discovery, return to the homepage.",
        ],
        links: [
