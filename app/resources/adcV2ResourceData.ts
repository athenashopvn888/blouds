...
export const ADC_V2_NEW_PAGES: ResourcePage[] = [
  ...
  article({
    ...
    links: links(["Native Smokes", "/resources/native-smokes"], ["Backwoods and Grabba Guide", "/resources/native-smokes/backwoods-grabba-guide"], ["Nicotine Pouches", "/resources/nicotine-pouches"], ["Cigarettes", "/items/cigarettes"], ["Queen Street West Native Cigarettes", "/native-cigarettes-brampton-queen"], ["Resource Centre", resourcesHub], ["Blouds Dispensary Brampton", "/weed-dispensary-brampton"]),
