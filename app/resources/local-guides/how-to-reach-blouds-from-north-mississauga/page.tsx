...
export default function Page() {
  return <AreaIntentPage eyebrow="Brampton commuter guide" h1="How to Reach Blouds Dispensary on Queen St W From North Mississauga" addressLine="Destination: 117 Queen St W, Brampton" storeHref="/weed-dispensary-brampton" storeLabel="Queen Street Walk-In Store" intro={[
    ...
    { heading: "One Queen Street West Store", paragraphs: ["The destination is Blouds Dispensary at 117 Queen St W in Brampton. A Hillcrest or Kennedy Road cannabis store is a different Brampton location and should not be used as the destination for this route guide."] },
  ]} />;
}
