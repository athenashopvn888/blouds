...
export const gbpLocation = {
  ...
  longitude: "-79.762376",
  hours: ["Open 24 Hours"],
  seoTitle: "Queen St W Brampton Dispensary | Blouds 24/7",
  metaDescription: "Walk-in Brampton dispensary at 117 Queen St W. Open 24 hours. Review the current menu before visiting. Adults 19+.",
  localLandmarks: ["Brampton", "Downtown Brampton", "Queen Street"],
  introVariant: "Blouds Dispensary is the Queen Street West walk-in cannabis store at 117 Queen Street West in Brampton. Downtown Brampton shoppers use this page to plan a Queen Street visit, not a Mississauga visit or a Kennedy Road visit.",
