/**
 * Tier-page schema contract (MJ01 reference, rolled to BLS01).
 *
 * SITE_ORIGIN must stay identical to gbp-location SITE_ORIGIN / homepage WebSite+Store @ids.
 * Keep this file free of gbp-location runtime imports so Node contract tests can load it.
 *
 ...
 * Queen Street West NAP only: 117 Queen St W, Brampton, ON L6Y 1M3 · +1 437-371-5377.
 */
