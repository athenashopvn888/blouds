...
export const SEO_PAGES: SeoPageData[] = [
  {
    ...
    title: "Brampton Weed Dispensary — Blouds Dispensary | 24 Hours | Brampton St",
    metaDescription: "Blouds Dispensary is Brampton's #1 24-hour weed dispensary at 117 Queen St W in ByWard Market. 200+ strains, THC up to 39%, edibles, vapes, concentrates & more. Walk in anytime.",
    h1: "Brampton Weed Dispensary — Blouds Dispensary",
    icon: "✨",
    heroTagline: "Premium Cannabis on Brampton St · Open 24 Hours · Walk-In Welcome",
    sections: [
      {
        heading: "Brampton's Premier Cannabis Destination",
        body: "Blouds Dispensary is a premium cannabis dispensary located at 117 Queen St W in the heart of Brampton's vibrant ByWard Market neighbourhood. We carry over 200 hand-picked cannabis strains across five quality tiers — from ultra-rare Exotic genetics with THC up to 39% to affordable Budget flower starting at just $3/g. Whether you're a connoisseur seeking the rarest strains or a daily smoker looking for reliable value, Blouds Dispensary has the perfect flower for you. We're proud to be one of Brampton's most trusted dispensaries, serving the ByWard Market community 24 hours a day, 7 days a week.",
      },
      {
      ...
      },
      {
        ...
        body: "Blouds Dispensary is more than just a flower shop. We carry a comprehensive selection of cannabis edibles (gummies, chocolates, baked goods), vape pens and disposable vapes, concentrates (shatter, wax, hash, diamonds, live resin), pre-rolled joints, magic mushrooms, native cigarettes, rolling papers, and accessories. Our live digital menu at bloudsdispensary.ca updates in real time so you always know exactly what's in stock before you make the trip.",
      },
      {
      ...
      },
      {
        ...
        body: "Blouds Dispensary proudly serves customers from across the National Capital Region. Whether you're coming from ByWard Market, Sandy Hill, Lower Town, Centretown, the Glebe, Old Brampton South, Vanier, Orleans, Kanata, Barrhaven, or across the bridge from Gatineau and Hull, we welcome you. Our 24-hour operation means you can visit on your own schedule. Call us at (437) 425-0117 or visit us at 117 Queen St W, Brampton, ON L6Y 1M3.",
      },
    ],
    faqs: [
      ...
      { q: "What cannabis products does Blouds Dispensary carry?", a: "We carry 200+ strains of cannabis flower across 5 quality tiers (Exotic, Premium, AAA+, AA, Budget), plus edibles, vapes, concentrates, pre-rolls, magic mushrooms, native cigarettes, and accessories. Our menu updates in real time online." },
...

  {
    ...
    metaDescription: "Buy native cigarettes in Brampton at Blouds Dispensary. Wide selection of premium and value tobacco brands at the best prices. 117 Queen St W, ByWard Market. Open 24/7.",
    ...
    sections: [
      ...
      },
      {
        ...
        body: "There are three reasons Brampton smokers keep coming back to Blouds Dispensary for their cigarettes. First, our prices are among the lowest in the ByWard Market area — we buy in volume and pass the savings to our customers. Second, our selection is comprehensive — we carry brands and varieties that many other shops simply don't stock. Third, we're open 24 hours a day, 7 days a week. Need cigarettes at midnight? 3 AM? We're here. No other tobacco shop in downtown Brampton offers this level of convenience.",
      },
      {
        heading: "Convenient ByWard Market Location",
        body: "Our shop at 117 Queen St W is centrally located in Brampton's ByWard Market — easily accessible from Rideau St, Sussex Dr, and all major downtown routes. Whether you're walking, driving, or taking the bus, Blouds Dispensary is easy to reach. Free evening street parking is available on Brampton St and nearby streets. We serve customers from across Brampton including Lower Town, Sandy Hill, Centretown, Vanier, and across the bridge from Gatineau.",
      },
      {
    ...
    faqs: [
      ...
      { q: "Where can I buy cheap cigarettes in Brampton?", a: "Blouds Dispensary at 117 Queen St W offers some of the best cigarette prices in Brampton's ByWard Market area. We're open 24 hours so you can shop on your own schedule." },
      ...
      { q: "Where is Blouds Dispensary located?", a: "117 Queen St W, Brampton, ON L6Y 1M3 — in the ByWard Market. Near Rideau Centre, close to major bus routes, with free evening street parking available." },
    ],
  },
...

  {
    ...
    sections: [
      ...
      },
      {
        ...
        body: "Blouds Dispensary is centrally located and easily accessible from anywhere in Brampton. We regularly serve customers from: ByWard Market, Sandy Hill, Lower Town, Centretown, the Glebe, Old Brampton South, Vanier, New Edinburgh, Rockcliffe, Orleans, Kanata, Barrhaven, Nepean, Stittsville, and across the bridge from Gatineau, Hull, and Aylmer. We're near major OC Transpo routes and the Rideau Centre.",
      },
    ],
    faqs: [
      { q: "Where is the closest dispensary in ByWard Market?", a: "Blouds Dispensary at 117 Queen St W is conveniently located in the heart of ByWard Market — one of Brampton's most accessible neighbourhoods." },
      ...
      { q: "What neighbourhoods does Blouds Dispensary serve?", a: "We serve all of Brampton including ByWard Market, Sandy Hill, Lower Town, Centretown, the Glebe, Vanier, Orleans, Kanata, Barrhaven, and Gatineau/Hull across the bridge." },
