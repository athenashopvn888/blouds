...
export const CATEGORY_CONFIG: Record<string, CategoryInfo> = {
  ...
  "MAGIC & OTHERS": {
    ...
    seoDescription: "Blouds Dispensary carries a curated selection of magic mushrooms and specialty products in Brampton. From micro-dose capsules to dried psilocybin mushrooms, we stock products for both beginners and experienced psychonauts. Visit us at 117 Queen St W for our full selection.",
    faqs: [
