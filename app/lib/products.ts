...
export const CATEGORY_CONFIG: Record<string, CategoryInfo> = {
  ...
  "VAPE DISPOSABLE": {
    ...
    seoTitle: "THC Vape Disposables Brampton — Cannabis Vapes",
    seoIntro: "Browse the current THC Vape category at Blouds Dispensary in Brampton for listed product names, formats, package details, and prices.",
    seoDescription: "Use the THC Vape category to compare the cannabis vape products currently listed before visiting Blouds Dispensary at 117 Queen St W.",
    faqs: [
