...
export default function DeliveryContent() {
  ...
  return <main className={styles.main}>
    ...
    <div className={styles.ctaSection}><p>Visit us in-store at <strong>117 Queen St W, Brampton, ON L6Y 1M3</strong> — open <strong>24 hours</strong>. Call <strong>(437) 371-5377</strong>.</p></div>
