...
export const STATIC_POSTS: StaticBlogPost[] = [
  {
    ...
    "title": "How to Plan a Blouds Dispensary Visit Without Guessing",
    "seoTitle": "Blouds Dispensary Visit Guide | Weed Dispensary in Brampton",
    "seo_title": "Blouds Dispensary Visit Guide | Weed Dispensary in Brampton",
    "metaDescription": "Plan a Brampton visit to Blouds Dispensary with a clear shopper checklist for store details, menu categories, current listings, and staff questions.",
    "meta_description": "Plan a Brampton visit to Blouds Dispensary with a clear shopper checklist for store details, menu categories, current listings, and staff questions.",
    "h1": "How to Plan a Blouds Dispensary Visit Without Guessing",
    "excerpt": "A practical visit guide for Blouds Dispensary, written for shoppers who want the next step without the runaround.",
  ...
  },
  {
    ...
    "title": "How to Compare Blouds Dispensary Flower Without Guessing",
    "seoTitle": "Blouds Dispensary Flower Guide | Budget to Exotic",
    "seo_title": "Blouds Dispensary Flower Guide | Budget to Exotic",
    "metaDescription": "Compare Blouds Dispensary flower sections with natural guidance for cheap weed, budget weed, premium flower, exotic flower, and current menu checks.",
    "meta_description": "Compare Blouds Dispensary flower sections with natural guidance for cheap weed, budget weed, premium flower, exotic flower, and current menu checks.",
    "h1": "How to Compare Blouds Dispensary Flower Without Guessing",
    "excerpt": "A shopper-first flower guide for comparing Budget, AA, AAA+, Premium, and Exotic sections at Blouds Dispensary.",
    "authorName": "Jay Cloud",
    "authorHandle": "@JayAtBlouds",
    "authorRole": "House Writer",
    "author": "Jay Cloud",
  ...
  },
  {
    ...
    "title": "How to Shop the Blouds Dispensary Menu Like a Pro",
    "seoTitle": "Blouds Dispensary Menu Guide | Brampton Weed Store",
    "seo_title": "Blouds Dispensary Menu Guide | Brampton Weed Store",
    "metaDescription": "Shop the Blouds Dispensary menu with a simple shopper-first guide to flower, pre-rolls, edibles, THC vapes, concentrates, and current listings.",
    "meta_description": "Shop the Blouds Dispensary menu with a simple shopper-first guide to flower, pre-rolls, edibles, THC vapes, concentrates, and current listings.",
    "h1": "How to Shop the Blouds Dispensary Menu Like a Pro",
    "excerpt": "A natural guide to shopping the Blouds Dispensary menu without turning the visit into a guessing game.",
    "authorName": "Lennox Blue",
    "authorHandle": "@LennoxBlouds",
    "authorRole": "House Writer",
    "author": "Lennox Blue",
