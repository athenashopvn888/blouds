...
export const STATIC_POSTS: StaticBlogPost[] = [
  {
    ...
    "editorialRemark": {
      ...
      "authorName": "Jay Cloud",
      "authorHandle": "@JayAtBlouds",
      "authorRole": "House Writer",
      "body": "The address check is not boring; it is the part that saves the trip. Store names and old tabs can blur together, so matching Queen St W, the phone number, and the current page is worth the minute. Keep the menu loose, but keep the decision clean. That is the whole trick."
    },
  ...
  },
  {
    ...
    "editorialRemark": {
      "label": "Another House Writer Adds",
      "authorName": "Blouds Editorial",
      "authorHandle": "@BloudsEditorial",
  ...
  },
  {
    ...
    "oldTitle": "Blouds Dispensary Local Visit Guide for Adults 19+",
    "wordCount": 529,
    "businessReviewFlags": []
  }
];
