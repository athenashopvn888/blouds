...
Open the store page, browse the available menu/category sections, and use the contact or directions options when you are ready to plan your visit.`,
  ...
  },
  {
    ...
    title: "Blouds Dispensary Price and Flower Tier Guide",
    seoTitle: "Blouds Dispensary Price Tier Guide",
    seo_title: "Blouds Dispensary Price Tier Guide",
    metaDescription: "Blouds Dispensary guide to flower tiers, weight choices, unit value, and store visit planning in Brampton.",
    meta_description: "Blouds Dispensary guide to flower tiers, weight choices, unit value, and store visit planning in Brampton.",
    h1: "Blouds Dispensary Price and Flower Tier Guide",
    excerpt: "A simple guide to Blouds Dispensary flower tiers, weights, and unit value.",
    author: "The Blouds Dispensary Team",
    date: "2026-07-09",
    category: "Price Guide",
    readTime: "4 min",
    content: `## Blouds Dispensary Price and Flower Tier Guide

Blouds Dispensary makes flower shopping easier by organizing the menu into clear tiers. Start with the tier that matches the kind of flower you want, then choose the weight that fits your budget and visit.
...
For the smoothest visit, open the Blouds Dispensary menu before heading out. The live menu is the best place to compare current flower tiers, weights, and store-specific options. The store page is also useful for directions, contact details, and visit planning.
...
- Open the Blouds Dispensary store page for directions, contact details, and visit planning.
...
Use the live menu for current store-specific selection, then use the store page for directions, contact details, and visit planning.`,
  ...
  },
  {
    ...
    title: "Blouds Dispensary Local Visit Guide for Adults 19+",
    seoTitle: "Blouds Dispensary Local Visit Guide | Brampton Adult 19+",
    seo_title: "Blouds Dispensary Local Visit Guide | Brampton Adult 19+",
    metaDescription: "Plan a visit to Blouds Dispensary in Brampton with adult 19+ store-page checks, menu-category paths, and local directions context.",
    meta_description: "Plan a visit to Blouds Dispensary in Brampton with adult 19+ store-page checks, menu-category paths, and local directions context.",
    h1: "Blouds Dispensary Local Visit Guide for Adults 19+",
    excerpt: "Blouds Dispensary guide for adults 19+ checking local context, store pages, and menu-category paths around Brampton.",
    author: "The Blouds Dispensary Team",
    date: "2026-07-09",
    category: "Local Guide",
    readTime: "5 min",
    content: `Use this guide to confirm the right Blouds Dispensary storefront around Brampton, understand nearby street context, and choose the most useful store page or menu path before visiting.

For current details, start with the official store page or contact staff before leaving.

## Confirm The Right Storefront

Blouds Dispensary is tied to Brampton, nearby plazas, local roads, Brampton transit routes. Local shoppers often compare several nearby search results, so the first job of this page is to make the store identity, area context, and next click easy to understand.
...
- Open the Blouds Dispensary store page: [https://www.bloudsdispensary.ca/weed-dispensary-brampton](https://www.bloudsdispensary.ca/weed-dispensary-brampton)
- Browse more local guides from the blog: [https://www.bloudsdispensary.ca/blog](https://www.bloudsdispensary.ca/blog)
- Confirm store-specific details before heading out.

## FAQ

### Is this guide only for Blouds Dispensary?

Yes. This page is written for Blouds Dispensary and the Brampton area.
...
Local shoppers search with neighbourhood and street language. Clear local context helps them confirm they are looking at the right store.`,
    ...
    internal_links_used: "/weed-dispensary-brampton, /blog, /blog/blouds-dispensary-local-visit-guide-2026",
    relatedLinks:     [
          {
                "title": "Blouds Dispensary store page",
                "url": "https://www.bloudsdispensary.ca/weed-dispensary-brampton",
                "description": "Official Blouds Dispensary page for local visit planning."
          },
          {
                "title": "Blouds Dispensary homepage",
                "url": "https://www.bloudsdispensary.ca/",
                "description": "Start from the Blouds Dispensary homepage."
          },
          {
                "title": "More Blouds Dispensary guides",
                "url": "https://www.bloudsdispensary.ca/blog",
